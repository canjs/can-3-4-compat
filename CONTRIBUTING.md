# Contributing to can-3-4-compat

## Developing Locally

This section will walk you through setting up the [repository](https://github.com//can-3-4-compat) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-3-4-compat, you can start by going to its [fork page](https://github.com//can-3-4-compat/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-3-4-compat
```
